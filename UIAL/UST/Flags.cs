...
namespace zuoanqh.UIAL.UST
{
    ...
    public class Flags
    {
        ...
        {
            flags = new List<Pair<string, double>>(Another.flags);
        ...
        /// </summary>
        public static IReadOnlyCollection<string> ALL_KNOWN_FLAGS => allFlags;

        /// <summary>
        ///     The subset of flags that does not use a numeral value.
        /// </summary>
        public static IReadOnlyCollection<string> NO_PARAMETER_FLAGS => noParamFlags;

        /// <summary>
        ///     KNOWN_FLAGS with NO_PARAMETER_FLAGS removed. funny name, i know. now stop cringing lol.
        /// </summary>
        public static IReadOnlyCollection<string> YES_PARAMETER_FLAGS => yesParamFlags;
        ...
        public Flags WithFlag(string Flag, double Value)
        {
            ...
            {
                //just append it
                var l = new List<Pair<string, double>>(flags) {new Pair<string, double>(Flag, Value)};
                return new Flags(l);
            }
